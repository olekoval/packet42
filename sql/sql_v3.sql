...
SELECT registration_area, edrpou, public_name, dv2.description AS тип_працівника, dv.description AS спеціальність, count
  FROM (
SELECT ev.registration_area, le.edrpou, le.public_name, employee_type, speciality ->>'speciality' AS speciality,
       COUNT(*) AS count
